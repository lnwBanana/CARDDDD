...
export const CARD_DATABASE: CardDefinition[] = [
    {
          id: "e3_khonbandiaokan_j3k",
              name: "E3_KhonBanDiaoKan-J3k",
                  title: "คนบ้านเดียวกัน",
                      image: "wiki image/การ์ดตัวละคร/E3_KhonBanDiaoKan-J3k.png",
                          rarity: "mythical",
                              faction: "เจ้ส",
                                  element: "👤 ตัวละคร",
                                      atk: 900, def: 850, spd: 800,
                                          lore: "คนบ้านเดียวกัน",
                                              cutsceneQuote:"",
                                                  cutsceneBg: "",
                                                    },
  {
        id: "e3_thumb_winner",
            name: "E3_Thumb-Winner",
                title: "นิ้วโป้ง",
                    image: "wiki image/การ์ดตัวละคร/E3_Thumb-Winner.png",
                        rarity: "mythical",
                            faction: "วินเนอร์",
                                element: "👤 ตัวละคร",
                                    atk: 950, def: 900, spd: 850,
                                        lore: "บ่มีไผหรอกสิไปล่าพยัก แล้วบ่หู่ว่าสิถูกมันขย่ำคืนเข้าใจบ่!!",
                                            cutsceneQuote: "",
                                                cutsceneBg: "",
                                                  },
    {
          id: "homelander",
              name: "Homelander",
                  title: "โฮมลาวเดอร์",
                      image: "wiki image/การ์ดตัวละคร/Homelander.png",
                          rarity: "mythical",
                              faction: "โฮมลาวเดอร์",
                                  element: "👤 ตัวละคร",
                                      atk: 980, def: 920, spd: 870,
                                          lore: "โฮมแลนด์หรอ ชื่อนั้นมันได้ตายไปแล้ว",
                                              cutsceneQuote: "",
                                                  cutsceneBg: "",
                                                    },
  {
  ...
  },
  {
        id: "E3_Neo-Warid",
            name: "E3_Neo-Warid",
                title: "",
                    image: "wiki image/การ์ดตัวละคร/E3_Neo-Warid.png",
                        rarity: "legendary",
                            faction: "วาริด",
                                element: "👤 ตัวละคร",
                                    atk: 780, def: 680, spd: 700,
                                        lore: "ไวตอนเก็บฝ้าย",
                                            cutsceneQuote: "",
                                                cutsceneBg: "",
                                                  },
  {
    ...
    {
          id: "oishilover_poom",
              name: "OishiLover-Poom",
                  title: "คนรักโออิชิ",
                      image: "wiki image/การ์ดตัวละคร/OishiLover-Poom.png",
                          rarity: "legendary",
                              faction: "ภูมิ",
                                  element: "👤 ตัวละคร",
                                      atk: 800, def: 750, spd: 720,
                                          lore: "โออิชิดีที่สุด",
                                              cutsceneQuote: "",
                                                  cutsceneBg: "",
                                                    },
                                                      {
                                                          id: "oishilover_captain",
                                                              name: "OishiLover-Captain",
                                                                  title: "คนรักโออิชิ",
                                                                      image: "wiki image/การ์ดตัวละคร/OishiLover-Captain.png",
                                                                          rarity: "legendary",
                                                                              faction: "กัปตัน",
                                                                                  element: "👤 ตัวละคร",
                                                                                      atk: 800, def: 750, spd: 720,
  ...
  },
  {
        id: "Hacker-Euro.",
            name: "Hacker-Euro",
                title: "",
                    image: "wiki imagee/การ์ดตัวละคร/Hacker-Euro.png",
                        rarity: "epic",
                            faction: "ยูโร",
                                element: "👤 ตัวละคร",
                                    atk: 780, def: 680, spd: 700,
                                        lore: "เงินแกไม่รอดแน่!",
                                            cutsceneQuote: "",
                                                cutsceneBg: "",
                                                  },
  {
...
{
    id: "e3_chicken_euro",
    name: "E3_Chicken-Euro",
    title: "ไก่อบ",
    image: "wiki image/การ์ดตัวละคร/E3_Chicken-Euro.jpeg",
    rarity: "legendary",
    faction: "ยูโร",
    element: "👤 ตัวละคร",
    atk: 780, def: 680, spd: 700,
  ...
  },
  {
      ...
      name: "JEK_Milk",
     title: "นม",
    image: "wiki image/การ์ดไช้แล้วทิ้ง/JEK_Milk.png",
    rarity: "uncommon",
     faction: "JEK",
     element: "🗑️ ไช้แล้วทิ้ง",
     atk: 0, def: 100, spd: 100,
     lore: "",
     cutsceneQuote: "",
     cutsceneBg: "",
    },
